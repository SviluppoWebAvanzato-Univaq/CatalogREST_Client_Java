# CatalogREST_Client_Java
> Example client for the RESTful API "Catalog" developed with Apache Commons HTTP

 This is a simple client for the "Catalog" RESTful API developed during the course lectures. It shows how to call the service using Apache Commons HTTP.
